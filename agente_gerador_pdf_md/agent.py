...
PROMPT_PATH = BASE_DIR / "prompts" / "prompt_agente_gerador_pdf.txt"
...
- Contém: Todas as seções (metadados, descrição, fluxograma, tabelas, diagnóstico, melhorias, KPIs, pendências)
...
pdf_subagent = Agent(
    ...
    output_key="pdf_markdown",  # salva o markdown gerado no state
